...
class StartManualProspectiveRegistrationRequest extends FormRequest {
    ...
    public function rules(): array { return [
        'full_name'=>['required','string','min:3','max:100'], 'email'=>['required','email:rfc','max:255','unique:users,email'], 'phone'=>['nullable','string','min:8','max:20'], 'birth_date'=>['nullable','date','before:today'],
