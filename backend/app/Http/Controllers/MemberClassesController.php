...
class MemberClassesController extends Controller
{
    ...
    public function join(Request $request, $classId)
    {
        ...
        if ($memberCount >= $class->max_participants) {
            return ApiResponse::error('Kelas sudah penuh.', [], 422);
        }
        ...
        if ($existing) {
            return ApiResponse::error('Anda sudah terdaftar di kelas ini.', [], 422);
        }
        ...
        return ApiResponse::success('Berhasil mendaftar kelas.', [], 201);
    }
