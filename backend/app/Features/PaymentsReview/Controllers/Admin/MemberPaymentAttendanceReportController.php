...
namespace App\Features\PaymentsReview\Controllers\Admin;
...
class MemberPaymentAttendanceReportController extends Controller
{
    public function summary(Request $request)
    {
        ...
        $paymentsTrend = $this->calculateTrend($paymentsNow, $paymentsPrev);
        ...
        $attendanceTrend = $this->calculateTrend($attendanceToday, $attendanceYesterday);
