...
namespace App\Features\HireTrainer\Controllers;
...
class BookingController extends Controller
{
    ...
    public function updateStatus(Request $request, int $id)
    {
        ...
        if ($data['status'] === TrainerBooking::STATUS_CANCELLED) {
            if ($response = ActionConfirmation::require($request, 'cancel booking', 'booking #' . $booking->id)) {
                return $response;
            }
        }
    ...
    {
        if ($response = ActionConfirmation::require($request, 'confirm trainer booking payment', 'booking #' . $booking->id)) {
            return $response;
        }
    ...
    {
        if ($response = ActionConfirmation::require($request, 'reject trainer booking payment', 'booking #' . $booking->id)) {
            return $response;
        }
