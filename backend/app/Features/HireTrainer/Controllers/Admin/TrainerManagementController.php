...
use App\Shared\Requests\Admin\StoreTrainerRequest;
use App\Shared\Requests\Admin\UpdateTrainerRequest;
use App\Models\Role;
...
class TrainerManagementController extends Controller
{
    ...
    {
        if ($confirmation = RequiresConfirmation::check($request, 'delete_trainer', $trainer->user?->email ?? (string) $trainer->id)) {
            return $confirmation;
        }
