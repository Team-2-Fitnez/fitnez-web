...
use App\Features\Trainer\Requests\TrainerMonitoringRequest;
...
class MemberFitnessMonitoringController extends Controller
{
    public function summary(Request $request)
    {
        ...
        $membersTrend = TrendCalculator::percentage($membersNow, $membersPrev);
        ...
        $plansTrend = TrendCalculator::percentage($plansNow, $plansPrev);
        ...
        $logsTrend = TrendCalculator::percentage($logsNow, $logsPrev);
        ...
        $mealsTrend = TrendCalculator::percentage($mealsNow, $mealsPrev);
