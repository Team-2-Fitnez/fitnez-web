...
abstract class BaseLoginStrategy {
    protected function validateUser(array $credentials, ?string $requiredRole = null): User {
        ...
        if($user->isPastMembershipRenewalGracePeriod()) { $user->delete(); throw ValidationException::withMessages(['email'=>['This account has passed the renewal deadline and has been removed.']]); }
