...
class MembershipPackageFactory {
    public static function defaultPackages(): array { return [
        ...
        ['code'=>'PKG_6_MONTHS_PLUS','name'=>'6 Months Plus','duration_months'=>6,'price'=>1200000,'free_class_access'=>true,'benefits'=>['Gym access for 6 months','Free class access']],
        ['code'=>'PKG_12_MONTHS_PREMIUM','name'=>'12 Months Premium','duration_months'=>12,'price'=>2200000,'free_class_access'=>true,'benefits'=>['Gym access for 12 months','Free class access']],
    ]; }
}
