...
<template>
  <div class="landing-page-root bg-background text-on-background font-body-md selection:bg-primary-fixed selection:text-on-primary-fixed">
    ...
    <button @click="openCookieSettings" class="fixed bottom-6 right-6 bg-[#f97316] text-white px-6 py-3 rounded-full shadow-2xl font-bold text-sm flex items-center gap-2 hover:-translate-y-1 hover:shadow-[0_10px_25px_-5px_rgba(249,115,22,0.5)] transition-all z-50">
...
<style scoped>
@import '../components/landing/landing-public.css';
