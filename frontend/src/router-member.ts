...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/400', name: 'member-bad-request', component: () => import('@/features/ErrorPages/pages/ClientErrorPage.vue'), meta: { statusCode: 400 } },
    { path: '/401', name: 'member-unauthorized', component: () => import('@/features/ErrorPages/pages/ClientErrorPage.vue'), meta: { statusCode: 401 } },
    { path: '/403', name: 'member-forbidden', component: () => import('@/features/ErrorPages/pages/ClientErrorPage.vue'), meta: { statusCode: 403 } },
    { path: '/408', name: 'member-request-timeout', component: () => import('@/features/ErrorPages/pages/ClientErrorPage.vue'), meta: { statusCode: 408 } },
    { path: '/404', name: 'member-not-found', component: () => import('@/features/ErrorPages/pages/ClientErrorPage.vue'), meta: { statusCode: 404 } },
