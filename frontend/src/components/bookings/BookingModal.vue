  ...
  <div class="modal-card">
    ...
    <template v-if="step === 'form'">
      ...
      <form @submit.prevent="onSubmit" class="form-grid">
        ...
        <div class="form-field">
          ...
          <div class="choice-grid" style="grid-template-columns: repeat(3, 1fr); gap: 0.5rem;">
            <button
              ...
              :key="n"
              type="button"
              :class="['choice-card', sessions_per_week === n && 'choice-card-active']"
              @click="sessions_per_week = n; session_days = session_days.slice(0, n)"
            >
        ...
        <div class="form-field">
          <label class="form-label">Choose {{ sessions_per_week }} day(s)</label>
          <div class="day-grid">
            <button
              v-for="day in allDays"
              :key="day.value"
              type="button"
              :class="['day-chip', session_days.includes(day.value) && 'day-chip-active']"
              :disabled="!session_days.includes(day.value) && session_days.length >= sessions_per_week"
        ...
        <div class="price-breakdown">
          ...
          <div class="price-row">
            <span>Total sessions ({{ sessions_per_week }} × 4 weeks)</span>
...
const totalSessions = computed(() => (sessions_per_week.value || 3) * 4)
