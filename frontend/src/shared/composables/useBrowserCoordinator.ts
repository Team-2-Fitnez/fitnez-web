...
import { browserTrackingService, createBrowserIdentity, createHeartbeatPayload } from '@/shared/services/browserTrackingService'
import { useBrowserTrackingStore } from '@/shared/stores/browserTrackingStore'
