...
import FitnezInput from '@/shared/components/ui/FitnezInput.vue'
import FitnezButton from '@/shared/components/ui/FitnezButton.vue'
import { useMealPlanStore } from '@/features/Mealplan/stores/mealPlanStore'
import { useAutoRefresh } from '@/shared/composables/useAutoRefresh'
import { calculateNutritionNeeds } from '@/features/NutritionCalculator/services/nutritionCalculator'
...
function calculate() {
  ...
  result.value = calculateNutritionNeeds({
